...
- `M7.2` is in progress in the parity backlog; the coordinator/policy core plus backend adapters and WebSocket/IM/HTTP entry-point rewiring now exist, but scheduled-task integration and richer execution-mode selection are still pending.
...
- The formal `M6` roadmap is exhausted. If the user continues parity work, the next real entrypoint is `M7.2.3`, not `M7.1`.
...
- If resuming during `M7.2`, also skim `services/execution_coordinator.py`, `services/execution_policy.py`, `services/execution_backends.py`, `services/execution_runtime.py`, `services/group_queue.py`, `tests/services/test_execution_coordinator.py`, `tests/services/test_execution_policy.py`, `tests/services/test_execution_backends.py`, `docs/plans/2026-03-12-m7-2-execution-plane-parity-design.md`, `docs/plans/2026-03-12-m7-2-execution-plane-parity.md`, `docs/plans/2026-03-12-m7-2-2-execution-backend-adapters-design.md`, and `docs/plans/2026-03-12-m7-2-2-execution-backend-adapters.md` because the coordinator/policy core plus backend adapters are already present and the next real step is `M7.2.3` scheduled-task/policy follow-up.
- If the user explicitly chooses to continue parity work past `M7.1`, resume from `M7.2.3` after skimming `services/execution_coordinator.py`, `services/execution_policy.py`, `services/execution_backends.py`, `services/execution_runtime.py`, `services/group_queue.py`, `tests/services/test_execution_coordinator.py`, `tests/services/test_execution_policy.py`, `tests/services/test_execution_backends.py`, `docs/plans/2026-03-12-m7-2-execution-plane-parity-design.md`, `docs/plans/2026-03-12-m7-2-execution-plane-parity.md`, `docs/plans/2026-03-12-m7-2-2-execution-backend-adapters-design.md`, and `docs/plans/2026-03-12-m7-2-2-execution-backend-adapters.md`.
...
- `.venv/bin/pytest -o addopts='' tests/services/test_execution_coordinator.py tests/services/test_execution_policy.py tests/services/test_execution_backends.py -q`: run the current `M7.2` coordinator/backends focused suite.
