...
- If resuming after `M6.5.1`, also skim `pyproject.toml`, `README.md`, and `docs/progress.md` because the current release plan targets tag `v1.0.0` while intentionally leaving package/runtime version strings at `0.1.0` until `M6.5.2+`.
