...
- `M7.2` is in progress in the parity backlog; `M7.2.1` ~ `M7.2.5` are now complete, including coordinator/policy core, backend adapters, scheduled-task + caller-facing mode inputs, minimal workspace/session lifecycle, and queue/executor cancel-timeout boundary hardening. The next real parity step is `M7.2.6` status/recovery signaling.
...
- The formal `M6` roadmap is exhausted. If the user continues parity work, the next real entrypoint is `M7.2.6`, not `M7.1`.
...
- If resuming during `M7.2`, also skim `services/workspace_lifecycle.py`, `services/execution_coordinator.py`, `services/execution_policy.py`, `services/execution_backends.py`, `services/execution_runtime.py`, `services/group_queue.py`, `infra/runtime/openai.py`, `infra/exec/process.py`, `tests/services/test_workspace_lifecycle.py`, `tests/services/test_execution_coordinator.py`, `tests/services/test_execution_policy.py`, `tests/services/test_execution_backends.py`, `tests/infra/runtime/test_openai.py`, `tests/infra/exec/test_process.py`, `docs/plans/2026-03-12-m7-2-execution-plane-parity-design.md`, `docs/plans/2026-03-12-m7-2-execution-plane-parity.md`, `docs/plans/2026-03-12-m7-2-2-execution-backend-adapters-design.md`, `docs/plans/2026-03-12-m7-2-2-execution-backend-adapters.md`, `docs/plans/2026-03-13-m7-2-3-scheduled-tasks-and-mode-inputs-design.md`, `docs/plans/2026-03-13-m7-2-4-session-workspace-lifecycle-design.md`, and `docs/plans/2026-03-13-m7-2-5-cancel-timeout-boundary-design.md` because the next real step is `M7.2.6` status/recovery signaling on top of the current lifecycle and cleanup boundary.
- If the user explicitly chooses to continue parity work past `M7.1`, resume from `M7.2.6` after skimming `services/workspace_lifecycle.py`, `services/execution_coordinator.py`, `services/execution_policy.py`, `services/execution_backends.py`, `services/execution_runtime.py`, `services/group_queue.py`, `infra/runtime/openai.py`, `infra/exec/process.py`, `tests/services/test_workspace_lifecycle.py`, `tests/services/test_execution_coordinator.py`, `tests/services/test_execution_policy.py`, `tests/services/test_execution_backends.py`, `tests/infra/runtime/test_openai.py`, `tests/infra/exec/test_process.py`, `docs/plans/2026-03-12-m7-2-execution-plane-parity-design.md`, `docs/plans/2026-03-12-m7-2-2-execution-backend-adapters-design.md`, `docs/plans/2026-03-13-m7-2-3-scheduled-tasks-and-mode-inputs-design.md`, `docs/plans/2026-03-13-m7-2-4-session-workspace-lifecycle-design.md`, and `docs/plans/2026-03-13-m7-2-5-cancel-timeout-boundary-design.md`.
