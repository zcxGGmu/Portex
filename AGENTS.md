...
## Current Baseline Snapshot (2026-03-13)
...
- The formal `M6` roadmap is exhausted. If the user continues parity work, the next real entrypoint is `M7.3.3`, not `M7.1`.
...
- If resuming after `M7.2`, also skim `services/workspace_lifecycle.py`, `services/execution_coordinator.py`, `services/execution_policy.py`, `services/execution_backends.py`, `services/execution_runtime.py`, `services/group_queue.py`, `infra/runtime/openai.py`, `infra/exec/process.py`, `app/routes/executions.py`, `tests/services/test_workspace_lifecycle.py`, `tests/services/test_execution_coordinator.py`, `tests/services/test_execution_policy.py`, `tests/services/test_execution_backends.py`, `tests/app/routes/test_execution_routes.py`, `tests/app/routes/test_websocket_routes.py`, `tests/infra/runtime/test_openai.py`, `tests/infra/exec/test_process.py`, `docs/plans/2026-03-12-m7-2-execution-plane-parity-design.md`, `docs/plans/2026-03-12-m7-2-execution-plane-parity.md`, `docs/plans/2026-03-12-m7-2-2-execution-backend-adapters-design.md`, `docs/plans/2026-03-12-m7-2-2-execution-backend-adapters.md`, `docs/plans/2026-03-13-m7-2-3-scheduled-tasks-and-mode-inputs-design.md`, `docs/plans/2026-03-13-m7-2-4-session-workspace-lifecycle-design.md`, `docs/plans/2026-03-13-m7-2-5-cancel-timeout-boundary-design.md`, `docs/plans/2026-03-13-m7-2-6-status-recovery-signaling-design.md`, and `docs/plans/2026-03-13-m7-2-7-focused-tests-design.md` because the next real step is `M7.3.3` workspace/group binding parity on top of the now-complete execution plane plus the completed `M7.3.1` / `M7.3.2` topology work.
- If resuming after `M7.3.2`, also skim `services/group_registry.py`, `domain/models/group.py`, `scripts/init_db.py`, `app/routes/auth.py`, `app/routes/groups.py`, `app/routes/messages.py`, `tests/services/test_group_registry.py`, `tests/domain/models/test_models.py`, `tests/scripts/test_init_db.py`, `tests/app/routes/test_api_routes.py`, `tests/app/routes/test_message_routes.py`, `docs/plans/2026-03-13-m7-3-1-persisted-group-listing-design.md`, `docs/plans/2026-03-13-m7-3-1-persisted-group-listing.md`, `docs/plans/2026-03-13-m7-3-2-workspace-topology-design.md`, and `docs/plans/2026-03-13-m7-3-2-workspace-topology.md` because `M7.3.3` now builds directly on the canonical `is_home` / `web:*` workspace topology and the SQLite compatibility path for `registered_groups`.
- If the user explicitly chooses to continue parity work past `M7.1`, resume from `M7.3.3` after skimming `services/workspace_lifecycle.py`, `services/execution_coordinator.py`, `services/execution_policy.py`, `services/execution_backends.py`, `services/execution_runtime.py`, `services/group_queue.py`, `infra/runtime/openai.py`, `infra/exec/process.py`, `app/routes/executions.py`, `services/group_registry.py`, `domain/models/group.py`, `scripts/init_db.py`, `app/routes/auth.py`, `app/routes/groups.py`, `app/routes/messages.py`, `tests/services/test_workspace_lifecycle.py`, `tests/services/test_execution_coordinator.py`, `tests/services/test_execution_policy.py`, `tests/services/test_execution_backends.py`, `tests/app/routes/test_execution_routes.py`, `tests/app/routes/test_websocket_routes.py`, `tests/infra/runtime/test_openai.py`, `tests/infra/exec/test_process.py`, `tests/services/test_group_registry.py`, `tests/domain/models/test_models.py`, `tests/scripts/test_init_db.py`, `tests/app/routes/test_api_routes.py`, `tests/app/routes/test_message_routes.py`, `docs/plans/2026-03-12-m7-2-execution-plane-parity-design.md`, `docs/plans/2026-03-12-m7-2-2-execution-backend-adapters-design.md`, `docs/plans/2026-03-13-m7-2-3-scheduled-tasks-and-mode-inputs-design.md`, `docs/plans/2026-03-13-m7-2-4-session-workspace-lifecycle-design.md`, `docs/plans/2026-03-13-m7-2-5-cancel-timeout-boundary-design.md`, `docs/plans/2026-03-13-m7-2-6-status-recovery-signaling-design.md`, `docs/plans/2026-03-13-m7-2-7-focused-tests-design.md`, `docs/plans/2026-03-13-m7-3-1-persisted-group-listing-design.md`, `docs/plans/2026-03-13-m7-3-1-persisted-group-listing.md`, `docs/plans/2026-03-13-m7-3-2-workspace-topology-design.md`, and `docs/plans/2026-03-13-m7-3-2-workspace-topology.md`.
...
- `.venv/bin/pytest tests/services/test_group_registry.py tests/domain/models/test_models.py tests/scripts/test_init_db.py tests/app/routes/test_api_routes.py tests/app/routes/test_message_routes.py -q`: run the current `M7.3.2` workspace topology focused suite.
