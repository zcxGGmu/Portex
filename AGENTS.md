...
- The formal `M6` roadmap is exhausted. If the user continues parity work, the next real entrypoint is `M7.4.7`, not `M7.1`.
...
- If the user explicitly chooses to continue parity work past `M7.1`, resume from `M7.4.7` after skimming `services/workspace_lifecycle.py`, `services/execution_coordinator.py`, `services/execution_policy.py`, `services/execution_backends.py`, `services/execution_runtime.py`, `services/group_queue.py`, `infra/runtime/openai.py`, `infra/exec/process.py`, `app/routes/executions.py`, `services/group_registry.py`, `services/group_member_service.py`, `services/conversation_slot_service.py`, `services/workspace_files.py`, `services/memory.py`, `services/skills.py`, `services/mcp_servers.py`, `services/settings.py`, `domain/models/group.py`, `domain/models/group_member.py`, `domain/models/conversation_slot.py`, `scripts/init_db.py`, `app/routes/auth.py`, `app/routes/groups.py`, `app/routes/im.py`, `app/routes/messages.py`, `app/routes/monitor.py`, `app/routes/files.py`, `app/routes/memory.py`, `app/routes/skills.py`, `app/routes/mcp_servers.py`, `app/routes/settings.py`, `tests/services/test_workspace_lifecycle.py`, `tests/services/test_execution_coordinator.py`, `tests/services/test_execution_policy.py`, `tests/services/test_execution_backends.py`, `tests/services/test_group_registry.py`, `tests/services/test_group_member_service.py`, `tests/services/test_conversation_slot_service.py`, `tests/services/test_workspace_files.py`, `tests/services/test_memory_service.py`, `tests/services/test_skills_service.py`, `tests/services/test_mcp_servers_service.py`, `tests/services/test_settings_service.py`, `tests/app/routes/test_execution_routes.py`, `tests/app/routes/test_websocket_routes.py`, `tests/app/routes/test_im_routes.py`, `tests/app/routes/test_api_routes.py`, `tests/app/routes/test_message_routes.py`, `tests/app/routes/test_monitor_routes.py`, `tests/app/routes/test_file_routes.py`, `tests/app/routes/test_memory_routes.py`, `tests/app/routes/test_skills_routes.py`, `tests/app/routes/test_mcp_servers_routes.py`, `tests/app/routes/test_settings_routes.py`, `tests/infra/runtime/test_openai.py`, `tests/infra/exec/test_process.py`, `tests/domain/models/test_models.py`, `tests/scripts/test_init_db.py`, `docs/plans/2026-03-12-m7-2-execution-plane-parity-design.md`, `docs/plans/2026-03-14-m7-3-5-conversation-slots-design.md`, `docs/plans/2026-03-15-m7-4-3-memory-surface-design.md`, `docs/plans/2026-03-15-m7-4-4-skills-surface-design.md`, `docs/plans/2026-03-15-m7-4-5-mcp-servers-surface-design.md`, and `docs/plans/2026-03-15-m7-4-6-settings-surface-design.md`.
