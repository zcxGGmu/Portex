...
- This branch already includes the `M8.5.18` restart-oriented handoff sync commits; use current-branch `git log` for exact commit order, and treat `docs/progress.md` plus the latest functional milestone commits as source of truth.
