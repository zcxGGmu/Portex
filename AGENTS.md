...
- Latest restart-oriented handoff sync commit is `4c2340e` (`docs(handoff): sync M8.5.16 search sort context`). If this line drifts from `git log`, treat `docs/progress.md` plus the latest functional milestone commits as the source of truth.
