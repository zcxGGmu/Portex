...
- `M8.5.17` planning is complete on `main` (`docs/plans/2026-03-18-m8-5-17-terminal-relevance-ranking-design.md`, `docs/plans/2026-03-18-m8-5-17-terminal-relevance-ranking.md`); runtime implementation has not started yet and should remain a backend-only relevance-ranking refinement.
...
- If resuming after `M8.5.16`, also skim `docs/plans/2026-03-18-m8-5-16-terminal-search-sort-controls-design.md`, `docs/plans/2026-03-18-m8-5-16-terminal-search-sort-controls.md`, `docs/plans/2026-03-18-m8-5-17-terminal-relevance-ranking-design.md`, `docs/plans/2026-03-18-m8-5-17-terminal-relevance-ranking.md`, `services/terminal_sessions.py`, `app/routes/terminals.py`, `web/src/api/client.ts`, `web/src/hooks/useApi.ts`, `web/src/pages/Terminals.tsx`, `tests/services/test_terminal_sessions.py`, `tests/app/routes/test_terminal_routes.py`, and `tests/app/routes/test_api_routes.py` because `M8.5.16` is the current landed search baseline and `M8.5.17` is the next planned backend-only relevance-ranking refinement on top of that surface.
- If the user explicitly chooses to continue post-`M8.5.16` terminal work, keep `latest.json`/`/sessions/current/history` compatibility and branch cleanly into the planned `M8.5.17` relevance-ranking refinement without changing current RBAC boundaries.
...
- `.venv/bin/pytest tests/services/test_terminal_sessions.py tests/app/routes/test_terminal_monitor_routes.py tests/app/routes/test_terminal_routes.py tests/app/routes/test_terminal_websocket_routes.py tests/app/routes/test_api_routes.py -q`: run the `M8.5.16` functional baseline and `M8.5.17` planning-entry terminal focused suite on the latest `main` baseline.
