...
- `M7.3.5` design/plan docs now exist (`docs/plans/2026-03-14-m7-3-5-conversation-slots-design.md`, `docs/plans/2026-03-14-m7-3-5-conversation-slots.md`) and define the approved minimal conversation-slots direction under a workspace.
...
- The formal `M6` roadmap is exhausted. If the user continues parity work, the next real entrypoint is `M7.3.5` implementation, not `M7.1`.
