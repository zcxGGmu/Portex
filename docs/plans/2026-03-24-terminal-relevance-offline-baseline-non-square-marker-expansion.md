# Terminal Relevance Offline Baseline Non-Square Marker Expansion Implementation Plan

**Goal:** Expand offline terminal relevance coverage from 24 to 28 deterministic cases so the landed non-square marker branch behaviors are included in the offline benchmark.
...
### Task 1: Add RED Expectations For 28 Cases
...
- change case-count assertions from `24` to `28`
- assert the new non-square marker case IDs are present
...
- failure because the committed fixture still has 24 cases
...
**Step 1: Add non-square colon-marker pagination coverage**

- add a deterministic case derived from the landed `M8.5.29` pagination test

**Step 2: Add non-square colon-marker offset coverage**

- add a deterministic case derived from the landed `M8.5.29` offset tie-break test

**Step 3: Add non-square dash-marker pagination coverage**

- add a deterministic case derived from the landed `M8.5.30` pagination test

**Step 4: Add non-square dash-marker offset coverage**

- add a deterministic case derived from the landed `M8.5.30` offset tie-break test
...
- `case_count=28`, `pass_count=28`, `pass_rate=1.000`, `top1_accuracy=1.000`, `mrr=1.000`
...
**Step 1: Record the expanded non-square marker coverage**

- update baseline case count and metrics
- note the newly covered non-square marker pagination and offset paths
...
```bash
git add docs/plans/2026-03-24-terminal-relevance-offline-baseline-non-square-marker-expansion-design.md docs/plans/2026-03-24-terminal-relevance-offline-baseline-non-square-marker-expansion.md
git commit -m "docs(plans): add offline relevance non-square marker expansion plan"
...
git commit -m "feat(terminal): expand offline relevance non-square marker fixtures"

git add docs/progress.md tasks/todo.md
git commit -m "docs(handoff): sync offline relevance non-square marker context"
```
